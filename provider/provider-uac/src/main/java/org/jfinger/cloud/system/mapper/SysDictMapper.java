...
import org.jfinger.cloud.entity.model.DuplicateCheckVo;
...
public interface SysDictMapper extends BaseMapper<SysDict> {
	 ...
	 * @return
	 */
	@Select("select * from sys_dict where status = -1")
	 ...
	 * @param id
	 */
	@Update("update sys_dict set status = #{flag,jdbcType=INTEGER} where id = #{id,jdbcType=VARCHAR}")
	public void updateDictDelFlag(@Param("flag") int status, @Param("id") String id);
