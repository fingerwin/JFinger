...
public class SysPermissionTree implements Serializable {
    ...
    private static final long serialVersionUID = -3131213713138287797L;
    ...
    public SysPermissionTree(SysPermission permission) {
        ...
        this.delFlag = permission.getStatus() == CommonConstant.STATUS_DELETE ? 1 : 0;
        this.icon = permission.getIcon();
        this.isLeaf = permission.isLeaf();
        this.menuType = permission.getMenuType();
        this.name = permission.getName();
        this.parentId = permission.getParentId();
        this.sortNo = Double.valueOf(permission.getSort());
        ...
        this.internalOrExternal = permission.isTarget();
